...
Begin VB.Form abm_asientos2 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox c_ubica 
         Height          =   315
         ItemData        =   "CGR006B.frx":0882
         Left            =   8880
         List            =   "CGR006B.frx":088C
         TabIndex        =   4
         Top             =   840
         Width           =   1575
      End
   ...
   End
End
Attribute VB_Name = "abm_asientos2"
  ...
  Else
    If Val(t_renglon) = 0 Then
      ...
      If c_ubica.ListIndex = 0 Then
       'debe
       abm_asientos.msf1.AddItem abm_asientos.msf1.Rows & Chr$(9) & t_cod & Chr$(9) & t_detalle & Chr$(9) & Format$(Val(t_importe), "######0.00") & Chr$(9) & c_cuenta
      Else
       'haber
       abm_asientos.msf2.AddItem abm_asientos.msf2.Rows & Chr$(9) & t_cod & Chr$(9) & t_detalle & Chr$(9) & Format$(Val(t_importe), "######0.00") & Chr$(9) & c_cuenta
      End If
    Else
       'modifico
        If t_ubicaanterior = "D" Then
           If abm_asientos.msf1.Rows > 2 Then
               abm_asientos.msf1.RemoveItem (Val(t_renglon))
           Else
               abm_asientos.armagrid
           End If
           If c_ubica.ListIndex = 0 Then
              'modifico el mismo renglon
               abm_asientos.msf1.AddItem t_renglon & Chr$(9) & t_cod & Chr$(9) & t_detalle & Chr$(9) & Format$(Val(t_importe), "######0.00") & Chr$(9) & c_cuenta, Val(t_renglon)
           Else
              'saco de debe y paso a haber
               abm_asientos.msf2.AddItem abm_asientos.msf2.Rows & Chr$(9) & t_cod & Chr$(9) & t_detalle & Chr$(9) & Format$(Val(t_importe), "######0.00") & Chr$(9) & c_cuenta
           End If
       Else
           If abm_asientos.msf2.Rows > 2 Then
               abm_asientos.msf2.RemoveItem (Val(t_renglon))
           Else
           ...
           If c_ubica.ListIndex = 1 Then
              'modifico el mismo renglon
               abm_asientos.msf2.AddItem abm_asientos.msf2.Rows & Chr$(9) & t_cod & Chr$(9) & t_detalle & Chr$(9) & Format$(Val(t_importe), "######0.00") & Chr$(9) & c_cuenta, Val(t_renglon)
           Else
...
If KeyCode = vbKeyF6 Then
   t_detalle = abm_asientos.t_descripciong
End If
