...
If J = 6 Then
   ...
   Case "A"
      QUERY = "INSERT INTO a10([DEscripcion], [cod_barra])"
      QUERY = QUERY & " VALUES ('" & t_descripcion & "', " & Val(t_codbarra) & ")"
      cn1.BeginTrans
      cn1.Execute QUERY
      cn1.CommitTrans
   ...
   Case "M"
      ...
      QUERY = "update a10 set  [Descripcion]='" & t_descripcion & "' , [cod_barra]=" & Val(t_codbarra)
      QUERY = QUERY & " where [id_marca]= " & Val(t_id)
      cn1.BeginTrans
      cn1.Execute QUERY
      cn1.CommitTrans
      
   Case "B"
      QUERY = "DELETE FROM a10 WHERE [id_marca] = " & Val(t_id)
      cn1.BeginTrans
      cn1.Execute QUERY
      cn1.CommitTrans
