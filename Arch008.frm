...
If J = 6 Then
   ...
   Case "A"
      QUERY = "INSERT INTO a8([DEscripcion])"
   ...
   Case "M"
      ...
      QUERY = "update a8 set  [Descripcion]='" & t_descripcion & "'"
   ...
   Case "B"
      QUERY = "DELETE FROM a8 WHERE [id_grupo] = " & Val(t_id)
      cn1.BeginTrans
      cn1.Execute QUERY
      cn1.CommitTrans
