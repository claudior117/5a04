...
Begin VB.Form vta_afip_citi 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Modulo de Exportacion para el Siap CITI Ventas"
   ClientHeight    =   8805
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12060
   ...
   End
End
Attribute VB_Name = "vta_afip_citi"
...
Sub carga()
 ...
 Call armagrid
  ...
  While Not rs.EOF
    ...
    End If
      msf1.AddItem er & Chr$(9) & F & Chr(9) & rs("cliente02") & Chr(9) & td & Chr$(9) & cu & Chr$(9) & "" & Chr$(9) & PtV & Chr$(9) & nc & Chr(9) & t & Chr(9) & l & Chr$(9) & dl & Chr(9) & "2705" & Chr(9) & "0000000000" & Chr(9) & "2" & Chr(9) & rs("num_int")
     rs.MoveNext
  Wend
  Unload espere
...
While k <= msf1.Rows - 1
   ...
   c28 = "2"
      ...
      l = c1 & c2 & c3 & c4 & c5 & c6 & c7 & c8 & c9 & c10 & c11 & c12 & c13 & c14 & c15 & c16 & c17 & c18 & c19 & c20 & c21 & c22 & c23 & c24 & c25 & c26 & c27 & c28
