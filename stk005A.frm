...
Begin VB.Form stk_movint2 
   BackColor       =   &H00C0C0C0&
   Caption         =   "MOVIMIENTOS DE AJUSTE EN STOCK"
   ClientHeight    =   2175
   ClientLeft      =   75
   ClientTop       =   360
   ClientWidth     =   11880
...
Sub cargarenglon(t As String)
  ...
  If t = "A" Then
    r = stk_movint.msf1.Rows
    stk_movint.msf1.AddItem r & Chr(9) & Format$(ip, "00000") & Chr(9) & d & Chr(9) & cu & Chr(9) & t_detalle2 & Chr(9) & t_tipo & Chr(9) & Format$(Val(t_costo), "#####0.00") & Chr(9) & Format$(Val(t_costo) * cu, "#####0.00")
  Else
    r = t_renglon
    stk_movint.msf1.AddItem r & Chr(9) & Format$(ip, "00000") & Chr(9) & d & Chr(9) & cu & Chr(9) & t_detalle2 & Chr(9) & t_tipo & Chr(9) & Format$(Val(t_costo), "#####0.00") & Chr(9) & Format$(Val(t_costo) * cu, "#####0.00"), r
    stk_movint.msf1.RemoveItem r + 1
  End If
...
If KeyCode = vbKeyF6 Then
  t_detalle2 = stk_movint.t_detalle
End If
...
If KeyAscii = 13 Then
  ...
  Case Is = "S", Is = "E"
     ...
     Else
       Call cargarenglon("M")
     End If
     stk_movint.t_ajuste = stk_movint.sacatotales()
     Call limpia
     Me.Hide
     End If
  End Select
