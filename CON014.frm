...
Begin VB.Form con_busca_comp_apoc_excel 
   BackColor       =   &H00E0E0E0&
   Caption         =   "BUSCADOR DE FACTURAS APÓCRIFAS DESDE PLANILLA EXCEL"
   ClientHeight    =   8490
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   11880
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command1 
         Caption         =   "Importar excel comprobantes"
         Height          =   375
         Left            =   120
         TabIndex        =   12
         Top             =   240
   ...
   End
End
Attribute VB_Name = "con_busca_comp_apoc_excel"
...
Sub carga()
  ...
  While Not rs.EOF
      ...
      q = "select * from tc where [cuit] = " & rs("cuit")
      c = " and "
      If t_fecha <> "" Then
