...
Begin VB.Form vta_informevta6 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "INFORME DE VENTAS ACUMULADO POR PRODUCTOS(IMPORTES)"
   ClientHeight    =   8775
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12090
   ...
   End
End
Attribute VB_Name = "vta_informevta6"
