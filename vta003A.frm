        ...
        If (WSFEv1.AppServerStatus = "OK" And WSFEv1.DbServerStatus = "OK" And WSFEv1.AuthServerStatus = "OK") Then
            ...
            ' Establezco los valores de la factura a autorizar:
             ...
             If cbte_nro = Val(t_numcomp) Then
                   ...
                   End If
                    ...
                    'agrego opcionales version webservice 4
                    If para.version_webservice = 4 Then
                              tic = Format$(vta_clientes.t_codfe, "@@")
                              ok = WSFEv1.EstablecerCampoFactura("cancela_misma_moneda_ext", "N")
                              ok = WSFEv1.EstablecerCampoFactura("condicion_iva_receptor_id", tic)
                    End If
            ...
            If t_letra <> "C" Then
               ...
               If Val(t_perc) > 0 Then
                   ...
                   X = 1
                   While X < vta_facturacion_perc.msf1.Rows
                    id = Format$(Val(vta_facturacion_perc.msf1.TextMatrix(X, 6)), "#0")
                    Desc = vta_facturacion_perc.msf1.TextMatrix(X, 2)
                    importe = Format$(Val(vta_facturacion_perc.msf1.TextMatrix(X, 5)), "#########0.00")
                    alic = Format$(Val(vta_facturacion_perc.msf1.TextMatrix(X, 4)), "#0.0")
                    baseimp = Format$(Val(vta_facturacion_perc.msf1.TextMatrix(X, 3)), "########0.00")
                    ok = WSFEv1.AgregarTributo(id, Desc, baseimp, alic, importe)
                    X = X + 1
                   Wend
...
If Not rs2.EOF And Not rs2.BOF Then
 ...
 idtributo = rs2("id_otrostributos")
 cuenta = rs2("id_cuenta_i1")
...
If t_letra = "A" Then
    ...
    If Not rs2.EOF And Not rs2.BOF Then
         ...
         If renglon > 0 Then
            If (msf1.TextMatrix(i, 12) = "S") Then 'calcula para perc pàra el producto
                    Select Case Val(msf1.TextMatrix(i, 6))
                        Case Is = 21
                          tot5329 = tot5329 + Val(msf1.TextMatrix(i, 7))
                        Case Is = 10.5
                          tot5328 = tot5328 + Val(msf1.TextMatrix(i, 7))
                    End Select
      ...
      If retmin <= pt Then
         ...
         't_perc = Format$(Val(t_perc) + pt, "######0.00")
         'agrega en percepciones 5329 3%
         If Val(ret5329) > 0 Then
            X = 0
            encontro = 0
            While X < vta_facturacion_perc.msf1.Rows
              If Val(vta_facturacion_perc.msf1.TextMatrix(X, 1)) = 5329 Then
                ' vta_facturacion_perc.msf1.TextMatrix(X, 3) = Val(vta_facturacion_perc.msf1.TextMatrix(X, 3)) + tot5329
                ' vta_facturacion_perc.msf1.TextMatrix(X, 5) = Val(vta_facturacion_perc.msf1.TextMatrix(X, 5)) + ret5329
                 
                 If vta_facturacion_perc.msf1.Rows <= 2 Then
                   vta_facturacion_perc.armagrid
                 Else
                   vta_facturacion_perc.msf1.RemoveItem (X)
                    X = vta_facturacion_perc.msf1.Rows
                 End If
           ...
           If encontro = 0 Then
                  vta_facturacion_perc.msf1.AddItem vta_facturacion_perc.msf1.Rows & Chr(9) & 5329 & Chr(9) & "Perc. RG5329" & Chr(9) & tot5329 & Chr(9) & tasa5329 & Chr(9) & ret5329 & Chr(9) & codafip & Chr(9) & cuenta
           End If
        End If
        
        
        'agrega en percepciones 5328 (5329 1.5%)
         If (ret5328) > 0 Then
            X = 0
            encontro = 0
            While X < vta_facturacion_perc.msf1.Rows
              If Val(vta_facturacion_perc.msf1.TextMatrix(X, 1)) = 5328 Then
                 If vta_facturacion_perc.msf1.Rows <= 2 Then
                   vta_facturacion_perc.armagrid
                 Else
                   vta_facturacion_perc.msf1.RemoveItem (X)
           ...
           If encontro = 0 Then
                  vta_facturacion_perc.msf1.AddItem vta_facturacion_perc.msf1.Rows & Chr(9) & 5328 & Chr(9) & "Perc. RG5329(10.5)" & Chr(9) & tot5328 & Chr(9) & tasa5328 & Chr(9) & ret5328 & Chr(9) & codafip & Chr(9) & cuenta
           End If
        End If
