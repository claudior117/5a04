...
If Not rs.BOF And Not rs.EOF Then
  ...
  If Val(t_pu) = 0 Then
    t_pu = ""
  Else
   If vta_presup.Option1 = True And grecargocc > 0 Then
...
Sub cargarenglon(t As String)
  ...
  If t = "A" Then
    'nueva linea
    r = vta_presup.msf1.Rows
    If r < 25 Then
       vta_presup.msf1.AddItem r & Chr(9) & Format$(ip, "00000") & Chr(9) & d & Chr(9) & cu & Chr(9) & u & Chr$(9) & pu & Chr(9) & ti & Chr(9) & im & Chr(9) & puf & Chr(9) & Chr(9) & cr & Chr(9) & Format$(Val(t_tasaib), "####0.00")
  ...
  Else
    r = t_renglon
    vta_presup.msf1.AddItem r & Chr(9) & Format$(ip, "00000") & Chr(9) & d & Chr(9) & cu & Chr$(9) & u & Chr$(9) & pu & Chr(9) & ti & Chr(9) & im & Chr(9) & puf & Chr(9) & Chr(9) & cr & Chr(9) & Format$(Val(t_tasaib), "####0.00"), r
    vta_presup.msf1.RemoveItem r + 1
  End If
   
  s = 0
  v = 0
  For i = 1 To vta_presup.msf1.Rows - 1
    If r > 0 Then
      k = Val(vta_presup.msf1.TextMatrix(i, 7))
      s = s + k
      v = v + (k * Val(vta_presup.msf1.TextMatrix(i, 6)) / 100)
    End If
  Next i
  vta_presup.sacatotales
  para.producto_sel = 0
