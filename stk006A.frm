...
Begin VB.Form stk_ingreso2 
   ...
   End
End
Attribute VB_Name = "stk_ingreso2"
...
Sub cargarenglon(t As String)
  ...
  If t = "A" Then
    r = stk_ingreso.msf1.Rows
    stk_ingreso.msf1.AddItem r & Chr(9) & Format$(ip, "00000") & Chr(9) & d & Chr(9) & cu & Chr(9) & t_detalle2 & Chr(9) & t_tipo
  Else
    r = t_renglon
    stk_ingreso.msf1.AddItem r & Chr(9) & Format$(ip, "00000") & Chr(9) & d & Chr(9) & cu & Chr(9) & t_detalle2 & Chr(9) & t_tipo, r
    stk_ingreso.msf1.RemoveItem r + 1
  End If
...
If KeyCode = vbKeyF6 Then
  t_detalle2 = stk_ingreso.t_detalle
End If
