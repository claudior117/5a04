...
If J = 6 Then
   ...
   Case "A"
      QUERY = "INSERT INTO a9([DEscripcion])"
   ...
   Case "M"
      ...
      QUERY = "update a9 set  [Descripcion]='" & t_descripcion & "'"
      QUERY = QUERY & " where [id_departamento]= " & Val(t_id)
      cn1.BeginTrans
      cn1.Execute QUERY
      cn1.CommitTrans
      
   Case "B"
      QUERY = "DELETE FROM a9 WHERE [id_departamento] = " & Val(t_id)
      cn1.BeginTrans
      cn1.Execute QUERY
      cn1.CommitTrans
