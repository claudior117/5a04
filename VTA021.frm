...
Begin VB.Form vta_informevta2 
   ...
   Caption         =   "INFORME DE VENTAS ACUMULADO POR PRODUCTOS(UNIDADES)"
   ClientHeight    =   8775
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12090
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.OptionButton Option3 
         BackColor       =   &H00E0E0E0&
         Caption         =   "Acumulado x Prod. y Cliente"
         Height          =   195
         Left            =   3600
         TabIndex        =   30
         Top             =   240
   ...
   End
End
Attribute VB_Name = "vta_informevta2"
  ...
  While Not rs.EOF
    'busco el producto en las ventas
      ...
      If tr > 0 Or tf > 0 Or tnc > 0 Or tp > 0 Or td > 0 Then
       msf1.AddItem ip & Chr(9) & dp & Chr(9) & " " & Chr(9) & Format$(tr, "#####0.00") & Chr(9) & Format$(td, "#####0.00") & Chr(9) & Format$(tf, "#####0.00") & Chr(9) & Format$(tp, "#####0.00")
      End If
      rs.MoveNext
   Wend
   ...
   msf1.AddItem "" & Chr(9) & "" & Chr(9) & " " & Chr(9) & Format$(ttr, "#####0.00") & Chr(9) & Format$(ttd, "#####0.00") & Chr(9) & Format$(ttf, "#####0.00") & Chr(9) & Format$(ttp, "#####0.00")
   Set rs = Nothing
    ...
    'busco el producto en las ventas
      ...
      While Not rs2.EOF
        If p = 0 Then
           ...
           p = 1
        End If
        If cli <> rs2("vta_02.id_cliente") Then
           'muestro productos del cliente
           dcli = "  [" & rs2("cliente02") & "]"
           msf1.AddItem "" & Chr(9) & dcli & Chr(9) & " " & Chr(9) & Format$(trc, "#####0.00") & Chr(9) & Format$(tdc, "#####0.00") & Chr(9) & Format$(tfc, "#####0.00") & Chr(9) & Format$(tpc, "#####0.00")
...
Sub carga2()
  ...
  While Not rs.EOF
    'busco el producto en las ventas
      ...
      reg2 = reg2 + 1
      q = "select * from vta_02, vta_03, vta_01, vta_06 where [id_producto] = " & rs("id_producto") & " and vta_03.[num_int] = vta_02.[num_int] and vta_02.[id_cliente] = vta_01.[id_cliente] and vta_02.[id_tipocomp] = vta_06.[id_tipocomp] and vta_02.[sucursal] = vta_06.[sucursal] "
      c = " and "
   ...
   Wend
   msf1.AddItem "" & Chr(9) & "" & Chr(9) & " " & Chr(9) & "_____________________" & Chr(9) & "_____________________" & Chr(9) & "_____________________" & Chr(9) & "_____________________"
   msf1.AddItem "" & Chr(9) & "" & Chr(9) & "Totales Generales " & Chr(9) & Format$(ttr, "#####0.00") & Chr(9) & Format$(ttd, "#####0.00") & Chr(9) & Format$(ttf, "#####0.00") & Chr(9) & Format$(ttp, "#####0.00")
   Set rs = Nothing
...
Else
  msf1.TextMatrix(0, 0) = "Id."
  msf1.TextMatrix(0, 1) = "Producto / Cliente"
  msf1.TextMatrix(0, 2) = "Comprobante"
  msf1.TextMatrix(0, 7) = "Num.Int.Comp"

End If

 msf1.TextMatrix(0, 3) = "Remitido"
 msf1.TextMatrix(0, 4) = "Devoluc."
 msf1.TextMatrix(0, 5) = "Fact.y Nc."
 msf1.TextMatrix(0, 6) = "Pendiente"
