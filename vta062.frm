...
Begin VB.Form vta_listaprecios_4 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00C0C0C0&
   Caption         =   "LISTA DE PRECIOS (Formato 4)"
   ClientHeight    =   8595
   ClientLeft      =   75
   ClientTop       =   360
   ClientWidth     =   11880
   ...
   Begin VB.Frame Frame12 
      ...
      Begin VB.ComboBox c_tasaib 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "vta062.frx":0000
         Left            =   120
         List            =   "vta062.frx":0019
         TabIndex        =   43
         TabStop         =   0   'False
         Text            =   "Combo1"
         Top             =   240
   ...
   Begin VB.Frame Frame11 
      ...
      Begin VB.ComboBox c_tasa 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "vta062.frx":0092
         Left            =   120
         List            =   "vta062.frx":00AB
         TabIndex        =   41
         TabStop         =   0   'False
         Text            =   "Combo1"
         Top             =   240
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.ComboBox c_tipo 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "vta062.frx":1228
         Left            =   120
         List            =   "vta062.frx":1241
         TabIndex        =   26
         TabStop         =   0   'False
         Text            =   "Combo1"
         Top             =   240
   ...
   End
End
Attribute VB_Name = "vta_listaprecios_4"
 ...
 While Not rs.EOF
    ...
    d = rs("descripcion")
     ...
     If rs("moneda") = "P" Then
      ...
      pd = Format$(rs("precio_final") / para.cotizacion, "######0.00")
      pd2 = Format$(rs("pu") / para.cotizacion, "######0.00")
      
     Else
      p = Format$(rs("precio_final") * para.cotizacion, "######0.00")
      p2 = Format$(rs("pu") * para.cotizacion, "######0.00")
      pd = Format$(rs("precio_final"), "######0.00")
      pd2 = Format$(rs("pu"), "######0.00")
    ...
    Else
      ee = "E"
    End If
    msf1.AddItem b & Chr$(9) & d & Chr$(9) & p & Chr$(9) & p2 & Chr$(9) & c & Chr$(9) & ti & "%" & Chr$(9) & m & Chr$(9) & ee & Chr$(9) & pd & Chr$(9) & pd2
...
msf1.TextMatrix(0, 2) = "Final $"
msf1.TextMatrix(0, 3) = "s/Iva $"
  msf1.TextMatrix(0, 8) = "Final u$s"
  msf1.TextMatrix(0, 9) = "s/Iva u$s"

msf1.TextMatrix(0, 4) = "Stock"
