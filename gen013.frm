...
Begin VB.Form gen_embargoib 
   BackColor       =   &H00E0E0E0&
   Caption         =   "PROCESO DE ACTUALIZACION DEL PADRON DE EMBARGADOS POR RENTAS"
   ClientHeight    =   6420
   ClientLeft      =   75
   ClientTop       =   420
   ClientWidth     =   6015
   ...
   Begin VB.Frame Frame2 
      BackColor       =   &H00E0E0E0&
      Caption         =   "Ubicacion definitiva del archivo de origen"
      Height          =   735
      Left            =   120
      TabIndex        =   8
      Top             =   4200
   ...
   Begin VB.Label Label3 
      Alignment       =   2  'Center
      BackColor       =   &H00800080&
      Caption         =   "PADRON DE EMBARGADOS POR ARBA"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "gen_embargoib"
...
Dim l As String
If verifica Then
 J = MsgBox("Confirma Actualizacion del Padron de Embargos por ARBA. ", 4)
 If J = 6 Then
  'borrar bd.actual
  'If abrirconexionib Then
   ...
   While Not EOF(1)
    ...
    t = t + 1
    rs.AddNew
    rs("cuit") = Val(Mid$(l, 9, 11))
    rs("fecha") = Mid$(l, 1, 4) & "/" & Mid$(l, 5, 2) & "/" & Mid$(l, 8, 2)
    rs("importe") = 0
    rs.Update
    rs.MoveNext
   Wend
