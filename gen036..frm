...
Begin VB.Form gen_citi 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "CITI  VENTAS  UNIFICADO"
   ClientHeight    =   8805
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12060
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Label Label6 
         Caption         =   "Se generan 2 archivos de exportacion  c:\citivta.txt  y c:\alicuoV.txt"
         Height          =   255
         Left            =   240
         TabIndex        =   19
         Top             =   720
  ...
  While Not rs.EOF
    ...
    ' End If
     ...
     While Not rs2.EOF
        ...
        If p = r Then
           msf1.AddItem er & Chr$(9) & F & Chr(9) & rs("cliente02") & Chr(9) & cic & Chr$(9) & nic & Chr$(9) & tc & Chr$(9) & PtV & Chr$(9) & nc & Chr(9) & t & Chr(9) & "" & Chr$(9) & n & Chr(9) & ti & Chr(9) & iv & Chr(9) & r & Chr(9) & rs("num_int") & Chr(9) & obserr & Chr(9) & moneda & Chr(9) & cambio & Chr(9) & tio & Chr(9) & pin & Chr(9) & pip
        Else
           msf1.AddItem er & Chr$(9) & F & Chr(9) & rs("cliente02") & Chr(9) & cic & Chr$(9) & nic & Chr$(9) & tc & Chr$(9) & PtV & Chr$(9) & nc & Chr(9) & "" & Chr(9) & "" & Chr$(9) & n & Chr(9) & ti & Chr(9) & iv & Chr(9) & r & Chr(9) & rs("num_int") & Chr(9) & obserr & Chr(9) & moneda & Chr(9) & cambio & Chr(9) & tio & Chr(9) & pin & Chr(9) & pip
        End If
        p = p + 1
       rs2.MoveNext
     Wend
...
gen_seleccionacarpeta.t_llamada = "1"
...
msf1.TextMatrix(0, 18) = "Perc I.Nac"
msf1.TextMatrix(0, 18) = "Perc I.Prov"
...
If KeyCode = vbKeyF5 Then
  J = MsgBox("Confirma genera archivos para importar del aplicativo Citi Ventas. Carpeta destino " & t_carpeta, 4)
  If J = 6 Then
    If t_carpeta <> "" Then
      Call exporta
    Else
...
k = 1
a1 = t_carpeta & "citiv.txt"
Open a1 For Output As #1
ni15 = "000000000000000"
Detalle = String(75, " ")
While k <= msf1.Rows - 1
  If msf1.TextMatrix(k, 8) <> "" Then
   ...
   l = msf1.TextMatrix(k, 1) & msf1.TextMatrix(k, 5) & msf1.TextMatrix(k, 6) & msf1.TextMatrix(k, 7) & msf1.TextMatrix(k, 7) & msf1.TextMatrix(k, 3) & nd & Left$(Format$(msf1.TextMatrix(k, 2), "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@!"), 30) & t & ng & pnc & e & pn & pp & e & e & msf1.TextMatrix(k, 16) & tc & msf1.TextMatrix(k, 13) & too & e & msf1.TextMatrix(k, 1)
   Print #1, l
  End If
  k = k + 1
