...
Begin VB.Form gen_exportaretibweb 
   BackColor       =   &H00E0E0E0&
   Caption         =   "PROCESO PARA EXPORTAR RETENCIONES IB REALIZADAS VIA WEB"
   ClientHeight    =   6420
   ClientLeft      =   75
   ClientTop       =   420
   ClientWidth     =   7710
   ...
   Begin VB.Label Label8 
      Caption         =   "Donde el periodo es: AAAAMMQ, año mes y quincena. Si la presentacion es mensual la quincena es 0."
      ForeColor       =   &H000000FF&
      Height          =   615
      Left            =   120
      TabIndex        =   21
   ...
   Begin VB.Label Label1 
      Caption         =   "Este modulo genera un archivo .txt con las retenciones realizadas y las caracteristicas solicitadas por ARBA. "
      ForeColor       =   &H000000FF&
      Height          =   495
      Left            =   120
      TabIndex        =   7
   ...
   End
End
Attribute VB_Name = "gen_exportaretibweb"
...
If verifica Then
 ...
 c = 0
 z = 0
 J = MsgBox("Confirma Generacion de Archivo " & na, 4)
 If J = 6 Then
   ...
   While Not rs.EOF
    ...
    impc = Format(rs("total"), "00000000.00")
    linea = CUIT & fechac & succ & numc & impc & "A"
    Print #1, linea
    If Len(linea) = 47 Then
      c = c + 1
    End If
    r = r + 1
   ...
   Close #1
 End If
 MsgBox ("Proceso finalizado. Retenciones Exportadas " & r & "   Retenciones Correctas: " & c)
End If
Set rs = Nothing
