...
Begin VB.Form vta_actu_listaprov 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.CheckBox Check2 
         BackColor       =   &H00E0E0E0&
         Caption         =   "Estructura Costos (Dtos/Flete)"
         Height          =   255
         Left            =   120
         TabIndex        =   27
         Top             =   600
   ...
   End
End
Attribute VB_Name = "vta_actu_listaprov"
