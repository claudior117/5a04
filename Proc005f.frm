...
Begin VB.Form op_fp5 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "PAGO por TRANSFERNCIAS o DEBITO AUTOMATCO"
   ClientHeight    =   3840
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7005
...
Else
  t_fechad = Format$(Now, "dd/mm/yyyy")
End If
Call verifica_fechacorte(t_fechad)
End Sub
...
Sub modificarenglon()
  ...
  Case Is = "O" 'op
    If t_fp <> "" Then
     r = Val(t_fp)
     op.msf2.AddItem ip & Chr(9) & d & Chr(9) & T_NUMCH & " " & Chr(9) & c_banco & Chr(9) & t_titular & Chr(9) & c_banco.ItemData(c_banco.ListIndex) & Chr(9) & i & Chr(9) & Format$(t_fechad, "DD/MM/YYYY") & Chr(9) & "" & Chr(9) & c, r
     op.msf2.RemoveItem r + 1
    Else
     'r = op.msf2.Rows
     op.msf2.AddItem ip & Chr(9) & d & Chr(9) & T_NUMCH & " " & Chr(9) & c_banco & Chr(9) & t_titular & Chr(9) & c_banco.ItemData(c_banco.ListIndex) & Chr(9) & i & Chr(9) & Format$(t_fechad, "DD/MM/YYYY") & Chr(9) & "" & Chr(9) & c
    End If
  ...
  Case Is = "F" 'fact. compra contado
    ...
    If t_fp <> "" Then
     r = Val(t_fp)
     com_formapago.msf2.AddItem ip & Chr(9) & d & Chr(9) & T_NUMCH & " " & Chr(9) & c_banco & Chr(9) & t_titular & Chr(9) & c_banco.ItemData(c_banco.ListIndex) & Chr(9) & i & Chr(9) & Format$(t_fechad, "DD/MM/YYYY") & Chr(9) & "" & Chr(9) & c, r
     com_formapago.msf2.RemoveItem r + 1
    Else
     'r = op.msf2.Rows
     com_formapago.msf2.AddItem ip & Chr(9) & d & Chr(9) & T_NUMCH & " " & Chr(9) & c_banco & Chr(9) & t_titular & Chr(9) & c_banco.ItemData(c_banco.ListIndex) & Chr(9) & i & Chr(9) & Format$(t_fechad, "DD/MM/YYYY") & Chr(9) & "" & Chr(9) & c
    End If
