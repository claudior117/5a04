...
Begin VB.Form vta_remitos1_predef 
   BackColor       =   &H00C0C0C0&
   Caption         =   "INGRESO DE ARTICULOS REMITOS PREDEFINIDOS"
   ClientHeight    =   2175
   ClientLeft      =   945
   ClientTop       =   6825
   ClientWidth     =   11880
   ...
   End
End
Attribute VB_Name = "vta_remitos1_predef"
...
Sub cargarenglon(t As String)
 ...
 End If
  If t = "A" Then
     vta_remitos_predef.msf1.AddItem r & Chr(9) & Format$(ip, "00000") & Chr(9) & d & Chr(9) & cu & Chr(9) & u & Chr(9) & ti
    
  Else
    r = t_renglon
    vta_remitos_predef.msf1.AddItem r & Chr(9) & Format$(ip, "00000") & Chr(9) & d & Chr(9) & cu & Chr(9) & u & Chr(9) & ti, r
    vta_remitos_predef.msf1.RemoveItem r + 1
  End If
