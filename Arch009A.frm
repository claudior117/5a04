...
Begin VB.Form ABM_deptoS 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "DEPARTAMENTOS DE VENTA"
   ClientHeight    =   7935
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9810
...
q = "select * from a9 where [id_departamento] = " & Val(DataGrid1.Columns(0).CellValue(DataGrid1.Bookmark))
rs.Open q, cn1
 abm_deptos1!t_id = rs("id_departamento")
 abm_deptos1!t_descripcion = rs("descripcion")
 abm_deptos1.Show
...
Exit Sub
ERROR1:
  MsgBox ("Error al Cargar Departamentos. Proc.: LLENACAMPOS")
  Exit Sub
End Sub
