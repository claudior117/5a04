...
Begin VB.Form gen_libroivadigitalC 
   BackColor       =   &H00E0E0E0&
   ...
   End
End
Attribute VB_Name = "gen_libroivadigitalC"
...
Sub carga()
 ...
 Dim nic As String
 espere.Show
 espere.Label1 = "Espere...... Generando Libro Iva Digital"
 espere.Refresh
 Call armagrid
  ...
  While Not rs.EOF
     ...
     msf1.AddItem er & Chr$(9) & F & Chr(9) & rs("proveedor05") & Chr(9) & cic & Chr$(9) & nic & Chr$(9) & tc & Chr$(9) & PtV & Chr$(9) & nc & Chr(9) & t & Chr(9) & ng & Chr$(9) & s & Chr(9) & ti & Chr(9) & i & Chr$(9) & ct & Chr(9) & rs("num_int") & Chr(9) & obserr & Chr(9) & moneda & Chr(9) & cambio & Chr(9) & tio & Chr(9) & pin & Chr(9) & pip & Chr(9) & piv
...
gen_seleccionacarpeta.t_llamada = "5"
...
If KeyCode = vbKeyF5 Then
  J = MsgBox("Confirma genera archivos para Aplicativo Libro Iva Didital Compras. Carpeta destino " & t_carpeta, 4)
  If J = 6 Then
    If t_carpeta <> "" Then
      Call exporta
    Else
...
k = 1
a1 = t_carpeta & "libro_iva_digital_compras_cbte.txt"
...
k = 1
a1 = t_carpeta & "libro_iva_digital_compras_alicuotas.txt"
Open a1 For Output As #1
ni15 = "000000000000000"
ni16 = "                "
c2 = 0
...
MsgBox ("Operacion Terminada. Se exportaron " & c & " comprobantes y " & c2 & " alicuotas")
